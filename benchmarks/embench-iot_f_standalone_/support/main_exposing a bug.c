...
for (long long unsigned  i=1; i<64; i+=1){
	...
	//printf("868249/%llu = %llu   868249 mod %llu = %llu ",i, (868249L)/ i,(long long unsigned int )i, (long long unsigned int )(( 868249L)% i));

	//printf("868249 * %llu = %llu \n",i, (long long unsigned int )( 868249L)* i);
}
