...
int main ()
{
	...
	runs_count=-2;
	pthread_create( &t[0], NULL, benchmark_cubic_t, NULL);
	pthread_create( &t[1], NULL, benchmark_edn_t, NULL);
	for (int i=0; i<2; i++)
		pthread_join( t[i], NULL);
    ...
    runs_count=-2;
	pthread_create( &t[0], NULL, benchmark_md5_t, NULL);
	pthread_create( &t[1], NULL, benchmark_minver_t, NULL);	
	for (int i=0; i<2; i++)
		pthread_join( t[i], NULL);
    ...
    runs_count=-2;
	pthread_create( &t[0], NULL, benchmark_nettle_sha256_t, NULL);
	pthread_create( &t[1], NULL, benchmark_nsichneu_t, NULL);
	for (int i=0; i<2; i++)
		pthread_join( t[i], NULL);
    ...
    runs_count=-2;
	pthread_create( &t[0], NULL, benchmark_qrduino_t, NULL);
	pthread_create( &t[1], NULL, benchmark_sglib_combined_t, NULL);
	for (int i=0; i<2; i++)
		pthread_join( t[i], NULL);
    ...
    runs_count=-2;
	pthread_create( &t[0], NULL, benchmark_statemate_t, NULL);
	pthread_create( &t[1], NULL, benchmark_tarfind_t, NULL);
	for (int i=0; i<2; i++)
		pthread_join( t[i], NULL);
