...
int main ()
{
	...
	benchmark_cubic_t
	benchmark_edn_t
	benchmark_huffbench_t
	benchmark_matmult_int_t
	benchmark_md5sum_t
	benchmark_minver_t
	benchmark_nbody_t
	benchmark_nettle_aes_t
	benchmark_nettle_sha256_t
	benchmark_nsichneu_t
	benchmark_picojpeg_t
	benchmark_primecount_t
	benchmark_qrduino_t
	benchmark_sglib_combined_t
	benchmark_slre_t
	benchmark_st_t
	benchmark_statemate_t
	benchmark_tarfind_t
	benchmark_ud_t
	benchmark_wikisort_t*/
	printf("Main\n");fflush(stdout);
