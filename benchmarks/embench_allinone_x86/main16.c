...
int main ()
{
	...
	pthread_create( &t[8+0], NULL, benchmark_nbody_t, NULL);
	pthread_create( &t[8+1], NULL, benchmark_nettle_aes_t, NULL);
	pthread_create( &t[8+2], NULL, benchmark_nettle_sha256_t, NULL);
	pthread_create( &t[8+3], NULL, benchmark_nsichneu_t, NULL);
	pthread_create( &t[8+4], NULL, benchmark_picojpeg_t, NULL);
	pthread_create( &t[8+5], NULL, benchmark_primecount_t, NULL);		
	pthread_create( &t[8+6], NULL, benchmark_qrduino_t, NULL);
	pthread_create( &t[8+7], NULL, benchmark_sglib_combined_t, NULL);
	for (int i=0; i<16; i++)
	...
	pthread_create( &t[4], NULL, benchmark_ud_t, NULL);
	pthread_create( &t[5], NULL, benchmark_wikisort_t, NULL);
